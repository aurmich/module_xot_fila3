...
command=php /var/www/html/base_saluteora/laravel/artisan queue:work database --sleep=3 --tries=3 --max-time=3600
autostart=true
autorestart=true
user=www-data
numprocs=8
redirect_stderr=true
stdout_logfile=/var/www/html/base_saluteora/laravel/storage/logs/worker.log
```
