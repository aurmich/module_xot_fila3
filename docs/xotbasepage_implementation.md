...
```
/var/www/html/base_generic/laravel/Modules/Xot/app/Filament\Pages\XotBasePage.php
```
...
class DashboardSettings extends XotBasePage
{
    ...
    protected static string $view = 'generic::filament.pages.dashboard-settings';
...
- [pattern di estensione filament](/var/www/html/base_generic/laravel/Modules/Xot/docs/filament_extension_pattern.md)
- [best practices filament](/var/www/html/base_generic/laravel/Modules/<directory progetto>/docs/filament-best-practices.md)
