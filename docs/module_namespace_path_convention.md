...
```
/var/www/html/base_generic/laravel/Modules/{NomeModulo}/app/{Tipo}/...
```

per esempio:
- `/var/www/html/base_generic/laravel/Modules/<directory progetto>/app/Filament/Resources/...`
- `/var/www/html/base_generic/laravel/Modules/<directory progetto>/app/Models/...`
- `/var/www/html/base_generic/laravel/Modules/<directory progetto>/app/Http/Controllers/...`
...
```
/var/www/html/base_generic/laravel/Modules/{NomeModulo}/{Tipo}/...
```
...
|-----------|----------------|
| `Modules\<nome progetto>\Filament\Resources\DoctorResource` | `/var/www/html/base_generic/laravel/Modules/<directory progetto>/app/Filament/Resources/DoctorResource.php` |
| `Modules\User\Models\User` | `/var/www/html/base_generic/laravel/Modules/User/app/Models/User.php` |
...
- [convenzioni di codice](/var/www/html/base_generic/laravel/docs/conventions.md)
- [struttura progetto](/var/www/html/base_generic/laravel/docs/project-structure.md)
