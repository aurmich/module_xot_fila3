...
I moduli sono componenti funzionali che implementano la logica di business e vanno posizionati in `/var/www/html/saluteora/laravel/Modules/`:
...
I temi sono componenti di presentazione che implementano l'interfaccia utente e vanno posizionati in `/var/www/html/saluteora/laravel/Themes/`:
