...
```
/var/www/html/base_generic/laravel/Modules/Xot/app/Filament/Resources/Pages/XotBasePage.php
```
...
- [Pattern di Estensione](/var/www/html/base_generic/laravel/Modules/Xot/docs/filament/filament_best_practices.md)
- [Principi di Ereditarietà](/var/www/html/base_generic/laravel/Modules/Xot/docs/class_inheritance_principles.md)
- [Architettura Filament-Xot](/var/www/html/base_generic/laravel/Modules/Xot/docs/filament_xot_architecture.md)
