...
- [regole di ereditarietà in php](/var/www/html/base_generic/laravel/docs/standards/php-inheritance-rules.md)
- [estensione pattern filament](/var/www/html/base_generic/laravel/Modules/Xot/docs/filament_extension_pattern.md)
