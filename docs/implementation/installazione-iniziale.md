...
> ⚠️ **IMPORTANTE**: 
> - Il progetto DEVE essere installato in `/var/www/html/saluteora/laravel`
> - NON utilizzare variazioni come `laravel new saluteora` o `laravel new laravel --version=X.Y`
> - NON creare il progetto in `/var/www/html/saluteora/public_html` o altre posizioni
