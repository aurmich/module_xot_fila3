...
1. **Case Sensitivity Errata**:
   - **Percorso ERRATO**: `/var/www/html/base_saluteora/laravel/Modules/User/Resources`
   - **Percorso CORRETTO**: `/var/www/html/base_saluteora/laravel/Modules/User/resources`

   - **Percorso ERRATO**: `/var/www/html/base_saluteora/laravel/Modules/User/Config`
   - **Percorso CORRETTO**: `/var/www/html/base_saluteora/laravel/Modules/User/config`

2. **Posizione Errata del Codice PHP**:
   - **Percorso ERRATO**: `/var/www/html/base_saluteora/laravel/Modules/User/Filament/Widgets`
   - **Percorso CORRETTO**: `/var/www/html/base_saluteora/laravel/Modules/User/app/Filament/Widgets`
...
find /var/www/html/base_saluteora/laravel/Modules -type d -name "Resources" -o -name "Config" -o -name "Views" -o -name "Lang" -o -name "Images"

# Verifica codice PHP fuori da app/
find /var/www/html/base_saluteora/laravel/Modules -type d -name "Filament" -o -name "Http" -o -name "Models" | grep -v "/app/"
```
...
mv /var/www/html/base_saluteora/laravel/Modules/User/Resources /var/www/html/base_saluteora/laravel/Modules/User/resources_temp
mv /var/www/html/base_saluteora/laravel/Modules/User/resources_temp /var/www/html/base_saluteora/laravel/Modules/User/resources

mv /var/www/html/base_saluteora/laravel/Modules/User/Config /var/www/html/base_saluteora/laravel/Modules/User/config_temp
mv /var/www/html/base_saluteora/laravel/Modules/User/config_temp /var/www/html/base_saluteora/laravel/Modules/User/config
```
...
mkdir -p /var/www/html/base_saluteora/laravel/Modules/User/app/Filament

# Sposta i file nella posizione corretta
mv /var/www/html/base_saluteora/laravel/Modules/User/Filament/Widgets /var/www/html/base_saluteora/laravel/Modules/User/app/Filament/
```
