 ...
 * @method static PulseAggregate|null first()
 * @method static \Illuminate\Database\Eloquent\Collection<int, PulseAggregate> get()
 * @method static PulseAggregate create(array $attributes = [])
 * @method static PulseAggregate firstOrCreate(array $attributes = [], array $values = [])
 * @method static \Illuminate\Database\Eloquent\Builder<static>|PulseAggregate where(string|\Closure $column, mixed $operator = null, mixed $value = null, string $boolean = 'and')
 * @method static \Illuminate\Database\Eloquent\Builder<static>|PulseAggregate whereNotNull(string|\Illuminate\Contracts\Database\Query\Expression $columns)
