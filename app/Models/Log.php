 ...
 * @method static \Illuminate\Database\Eloquent\Collection<int, Log> get()
 * @method static Log create(array $attributes = [])
 * @method static Log firstOrCreate(array $attributes = [], array $values = [])
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Log where(string|\Closure $column, mixed $operator = null, mixed $value = null, string $boolean = 'and')
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Log whereNotNull(string|\Illuminate\Contracts\Database\Query\Expression $columns)
