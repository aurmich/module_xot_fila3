 ...
 *
 * @method static Session|null first()
 * @method static \Illuminate\Database\Eloquent\Collection<int, Session> get()
 * @method static Session create(array $attributes = [])
 * @method static Session firstOrCreate(array $attributes = [], array $values = [])
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Session where(string|\Closure $column, mixed $operator = null, mixed $value = null, string $boolean = 'and')
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Session whereNotNull(string|\Illuminate\Contracts\Database\Query\Expression $columns)
