...
enum DayOfWeek: int implements HasColor, HasDescription, HasIcon, HasLabel
{
    ...
    {
        return match ($this) {
            self::MONDAY => (string) __('saluteora::common.days.description.monday'),
            self::TUESDAY => (string) __('saluteora::common.days.description.tuesday'),
            self::WEDNESDAY => (string) __('saluteora::common.days.description.wednesday'),
            self::THURSDAY => (string) __('saluteora::common.days.description.thursday'),
            self::FRIDAY => (string) __('saluteora::common.days.description.friday'),
            self::SATURDAY => (string) __('saluteora::common.days.description.saturday'),
            self::SUNDAY => (string) __('saluteora::common.days.description.sunday'),
        };
    }
