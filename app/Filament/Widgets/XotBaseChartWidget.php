        ...
        return [
                ...
                'tooltip' => [
                    ...
                    'callbacks' => [
                        'label' => 'function(context) {
                            return "'.(string) __('salutemo::widgets.patient_registration_trend.total_registrations').'".replace(":count", context.parsed.y);
                        }',
                    ],
                ],
            ],
            'scales' => [
                'x' => [
                    ...
                    'title' => [
                        'display' => true,
                        'text' => (string) __('salutemo::widgets.patient_registration_trend.period.label'),
                    ],
                    'grid' => [
                        'display' => false,
                    ],
                ...
                'y' => [
                    ...
                    'title' => [
                        'display' => true,
                        'text' => (string) __('salutemo::widgets.patient_registration_trend.total_registrations'),
                    ],
                    'beginAtZero' => true,
                    'ticks' => [
                        'stepSize' => 1,
