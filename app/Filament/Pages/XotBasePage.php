...
abstract class XotBasePage extends FilamentPage implements HasForms
{
    ...
    public static function trans(string $key, array $replace = [], ?string $locale = null, bool $useFallback = true): string
    {
        ...
        $translation = (string) __($translationKey, $replace, $locale);
    ...
    protected function hasPermissionTo(string $permission): bool
    {
        ...
        return $user->hasPermissionTo($permission); /** @phpstan-ignore method.nonObject */
    }
    ...
    protected function getFormActions(): array
    {
        return [
            Action::make('save')
                ->label((string) __('filament-panels::resources/pages/edit-record.form.actions.save.label'))
                ->submit('save'),
        ];
    }
}
