...
4. **SEMPRE** verificare isset prima di accedere a proprietà magiche
5. **MAI** usare property_exists con modelli Eloquent

### **Esempio di Implementazione Corretta**
```php
// ✅ CORRETTO
$prop = isset($class->property) ? $class::$property : [];
```
